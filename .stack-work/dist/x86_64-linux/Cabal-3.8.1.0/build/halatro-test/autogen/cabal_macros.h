...
/* package halatro-0.1.0.0 */
#ifndef VERSION_halatro
#define VERSION_halatro "0.1.0.0"
#endif /* VERSION_halatro */
#ifndef MIN_VERSION_halatro
#define MIN_VERSION_halatro(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_halatro */
...
/* package tasty-reporter-muffled-0.1.0.0 */
#ifndef VERSION_tasty_reporter_muffled
#define VERSION_tasty_reporter_muffled "0.1.0.0"
#endif /* VERSION_tasty_reporter_muffled */
#ifndef MIN_VERSION_tasty_reporter_muffled
#define MIN_VERSION_tasty_reporter_muffled(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_tasty_reporter_muffled */
/* package text-2.0.2 */
#ifndef VERSION_text
...
#define CURRENT_COMPONENT_ID "halatro-0.1.0.0-8Jyk0gmkUkx9uzv1anuea5-halatro-test"
